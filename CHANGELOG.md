...
- **VPC Service Controls**: Added `bigquery.datasets.listSharedDatasetUsage` to BigQuery ingress permissions and missing `dataform.googleapis.com` ingress operation in the VPC SC reference output
